package com.example.gd12_pdf_c_10838
...
import com.example.gd12_pdf_c_10838.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun createPdf(nama: String, umur: String, tlp: String, alamat: String, kampus: String){
        ...
        val file = File(pdfPath, "pdf_10838.pdf")
        ...
        @SuppressLint("useCompatLoadingForDrawables") val d = getDrawable(R.drawable.gambar)
